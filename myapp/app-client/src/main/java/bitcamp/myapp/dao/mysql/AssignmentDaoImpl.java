...
public class AssignmentDaoImpl implements AssignmentDao {
  ...
  public void add(Assignment assignment) {
    try {
      Statement stmt = con.createStatement();
      stmt.executeUpdate(String.format("insert into assignments(title, content, deadline) values ('%s','%s','%s')",
  ...
  public int delete(int no) {
    try {
      Statement stmt = con.createStatement();
      return stmt.executeUpdate("delete from assignments where assignment_no=" + no);
    } catch (Exception e) {
  ...
  public int update(Assignment assignment) {
    try {
      Statement stmt = con.createStatement();
      return stmt.executeUpdate(String.format("update assignments set title='%s', content='%s', deadline='%s' where assignment_no=%d",
